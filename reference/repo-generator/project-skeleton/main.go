...
import (
	...
	"gitlab.com/b2c-e-commerce-platform/platform/backend/project-skeleton/config"
	"gitlab.com/b2c-e-commerce-platform/platform/backend/project-skeleton/router"
